            ...
            <form className="space-y-4 border border-gray-300 p-4 rounded-md bg-white bg-opacity-50" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 bg-white bg-opacity-50"
                />
              </div>
              <div>
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.Commitment1Year}
                  onChange={handleChange}
                  className="mt-1 block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 bg-white bg-opacity-50"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  name="Commitment2Year"
                  value={formData.Commitment2Year}
                  onChange={handleChange}
                  className="mt-1 block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 bg-white bg-opacity-50"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  value={formData.Commitment3Year}
                  onChange={handleChange}
                  className="mt-1 block w-full pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500 bg-white bg-opacity-50"
                />
              </div>
